...
{
	average_vel_filter();
	vel_goal_l = (100*avg_vel_lin-((avg_vel_ang*wheel_base)/2));  //multiply by 100 to translate into cm/s from m/s
	vel_goal_r = (100*avg_vel_lin+((avg_vel_ang*wheel_base)/2));
